...
public class ProgressBar extends SettingsPreferenceFragment implements
    ...
    private SwitchPreference mprogressbar_mirror;
    private SwitchPreference mprogressbar_reverse;
    private CustomSeekBarPreference mprogressbar_speed;
    private CustomSeekBarPreference mprogressbar_width;
    private CustomSeekBarPreference mprogressbar_length;
    private CustomSeekBarPreference mprogressbar_count;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mprogressbar_width = (CustomSeekBarPreference) findPreference(PROGRESSBAR_WIDTH);
        ...
        mprogressbar_length = (CustomSeekBarPreference) findPreference(PROGRESSBAR_LENGTH);
        ...
        mprogressbar_count = (CustomSeekBarPreference) findPreference(PROGRESSBAR_COUNT);
